...
public class ajouterevent implements Initializable {
    ...
    void ajouterEvent(ActionEvent event) {
        ...
        try {
            ...
            serviceevenement.ajouter(new evenement(1, tx_nom.getText(), tf_des.getText(), cb_lieu.getSelectionModel().getSelectedItem().toString(), dateevent,idmodif));
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        idmodif = controllers.affichercategorie.selectedId;

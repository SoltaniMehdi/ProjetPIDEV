...
public class AfficherLivraisonController {
    private MyDatabase Database = MyDatabase.getInstance();
...
ObservableList<Livraison1> filteredList = FXCollections.observableArrayList();
    ...
    private void pdf_user(ActionEvent event) {
        ...
        try{
            ...
            JasperDesign jDesign = JRXmlLoader.load("C:\\Users\\solta\\Desktop\\WorkshopPI - Copy1 Safe\\src\\main\\resources\\report.jrxml");
